...
typedef __int64 (STDCALL *fnPtrDllMainInit)(void);
...
typedef void (STDCALL *fnPtrCloseLogFile)(void);
...
typedef int (STDCALL *fnPtrGetElsetKeyMode)(void);
...
void LoadDllMainDll(void);
void FreeDllMainDll(void);
