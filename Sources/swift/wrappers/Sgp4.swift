...
public func Sgp4PosVelToKep(_ yr: Int32, _ day: Double,
                            _ pos: UnsafeMutablePointer<Double>,
                            _ vel: UnsafeMutablePointer<Double>,
...
public func Sgp4ReepochCsv(_ satKey: Int64, _ reepochDs50UTC: Double,
...
public func Sgp4GetPropOut(_ satKey: Int64, _ xf_Sgp4Out: Int32,
...
public func Sgp4GenEphems_OS(_ xa_tle: UnsafeMutablePointer<Double>,
                             _ startTime: Double, _ endTime: Double, _ stepSize: Double,
                             _ sgp4_ephem: Int32, _ arrSize: Int32,
                             _ ephemArr: UnsafeMutablePointer<(Double, Double, Double,
    ...
    return function(xa_tle, startTime, endTime, stepSize,
                    sgp4_ephem, arrSize, ephemArr, genEphemPts)
}
...
public func Sgp4GenEphems(_ satKey: Int64,
    ...
    return function(satKey, startTime, endTime, stepSize,
                    sgp4_ephem, arrSize, ephemArr, genEphemPts)
}
...
public func Sgp4PropAllSats(_ satKeys: UnsafeMutablePointer<Int64>, _ numOfSats: Int32,
                            _ ds50UTC: Double,
                            _ ephemArr: UnsafeMutablePointer<(Double, Double, Double,
